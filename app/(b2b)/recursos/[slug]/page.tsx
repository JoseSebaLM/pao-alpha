    ...
    <main className="min-h-screen bg-paper">
      ...
      <section className="py-16 px-4 md:px-8 bg-stone-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href={`https://wa.me/${WHATSAPP_CONFIG.number}?text=${encodeURIComponent("Hola Paola, me interesa solicitar un diagnóstico inicial para mi organización. Me gustaría conversar sobre los desafíos de mi equipo.")}`}
            target="_blank"
