...
export default function FloatingWhatsApp({ context = "default" }: FloatingWhatsAppProps) {
  ...
  return (
    ...
    >
      {/* Advertencia en hover - TEXTO EXACTO OBLIGATORIO (PRIV-002) */}
      <div 
        className={`absolute right-16 top-1/2 -translate-y-1/2 mr-4 max-w-[260px] bg-white rounded-xl shadow-lg border border-ink/10 p-4 transition-all duration-300 ${
          isHovered 
      ...
      >
        ...
        <div className="absolute -right-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-white border-t border-r border-ink/10 transform rotate-45" />
      </div>
